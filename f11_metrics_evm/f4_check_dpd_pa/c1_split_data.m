...
Description:
  ...
  frequency and save it to .mat file. The main difference from the previous
  script is that it generates only the first 80 us of the waveform, 
  corresponding to 11 data symbols (WLAN11N), instead of the complete 1 ms 
  frame.
