...
Description:
  ...
  output in .pwl format. Only the WLAN11N signal is considered in this 
  analysis. The simulated waveform corresponds to the first 80 µs of the 
  frame, while the complete WLAN11N frame has a duration of 1 ms. 
  Consequently, the signal beyond 80 µs is obtained by extrapolation and is
  not valid for EVM evaluation. Therefore, in Cadence, the Number of Data 
  Symbols parameter must be set to 11 when computing the EVM.
